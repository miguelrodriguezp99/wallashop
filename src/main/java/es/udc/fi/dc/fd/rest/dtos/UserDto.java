...
public class UserDto {
	...
	public UserDto(String userName, String password, String firstName, String lastName, String email, String avatar,
			String role) {
		super();
	 ...
	 * @param role      the role
	 */
	public UserDto(Long id, String userName, String firstName, String lastName, String email, String avatar,
			String role) {
